...
-------------------------------------------------------------------------------
	...
	set @sqlStatement = 'DELETE [' + @databaseName + '].[' + OBJECT_SCHEMA_NAME(@objectId) + '].[' + OBJECT_NAME(@objectId) + ']'
	set @outputMessage = 'Deleting all data from ' + QUOTENAME(OBJECT_NAME(@objectId))
