...
$d = $Server.databases[$Database].EnumObjects($objectsToDo) | Where-Object { ($_.Schema -eq 'dbo') -and ($_.Name -like "arpt*") }
...
$d | FOREACH-OBJECT { # for every object we have in the datatable.
    ...
    $SavePath = "$($DirectoryToSaveTo)\ArptView"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUj1KvCw3FdxVN8eFgKT6RY4uO
# ZlKgggMYMIIDFDCCAfygAwIBAgIQegXJmptVUKlJaZjT11rO5zANBgkqhkiG9w0B
...
# FTAjBgkqhkiG9w0BCQQxFgQUcKzgJbYBnGDBTqR3vyG+tkecCHYwDQYJKoZIhvcN
# AQEBBQAEggEAAZEEAhKfLkcugaT72ebaZpDm2ZvkEhuOnsuosjD1cEl1grNasNqK
# U56wuiTs78hhJOVRQccXtFRLoZ+BB+X9J98UMXF8+d8K1B99KSJ0yxGN+EyisTrs
# yDXzSpiSVchnd1CFD4JpTrWOYZGyBJ0BNNn3woCaK8bFjx4EbHumNvCAfJfTe6e0
# 2SulnAQMocksTiah2dMKZ3YcYrhjicWth/bjDN/DawumJBNm6ypo5EDhM/wiHcnE
# kXJ0lv3kJgLQc9N79g05b+BpawiZS2ll5GSmcyZ8NfawXU2UzkqPex1KUfmbYmeo
# CU+81j0tEnsJo7WqewFz/AHlcEr8nQANFg==
