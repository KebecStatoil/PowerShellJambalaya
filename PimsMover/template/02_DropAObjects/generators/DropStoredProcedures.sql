...
-------------------------------------------------------------------------------
	...
	set @sqlStatement = 'DROP PROCEDURE IF EXISTS [' + OBJECT_SCHEMA_NAME(@objectId) + '].[' + OBJECT_NAME(@objectId) + ']'
	set @outputMessage = 'Dropping Stored Procedure ' + QUOTENAME(OBJECT_NAME(@objectId))
