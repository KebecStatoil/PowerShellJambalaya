...
param(
    [string] $ConfigFullPath="$PSScriptRoot\..\config\SqlRunDataPump.json"
)
...
$logfile = "$PSScriptRoot\..\log\SqlRunDataPump.log"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU1y58WGpNbW0RizEJ3bZTwbsA
# X22gggMYMIIDFDCCAfygAwIBAgIQegXJmptVUKlJaZjT11rO5zANBgkqhkiG9w0B
...
# FTAjBgkqhkiG9w0BCQQxFgQUowAhwrRdqSKUZSSYZek9GhpNUQEwDQYJKoZIhvcN
# AQEBBQAEggEAv3xdhDzeNJTrnSBQx3ekOiHPnNYxMihUujn6M9SjB517PgMUYB36
# 04Ronzm80EDBoKqk+OusZC1EYbHHLncx02bnnTTwOBrJTPbU++u/EtSftq6Cv2w/
# Wmmgso6c/YEUvVySnyvRfkZKj3zNZg4NuRMPADL5zUrR0QnXe10KFHmu0aCmw2GL
# xKHU+20h++EIhAvF8bdTsb98b5h1RqCRXhqVmPVauP/jHG73TfaR5n5O3kiBSbBU
# bIMPlkV95X7wbe4kLnlf5LZau/a5KF2QXut61w2ewLzLtcYmDnAsSow+GkBxQW8o
# m3weSeZ6VChOgtGjlMDr6O5or4G2TXTs3Q==
