function Get-ConnectionString {
    ...
    $config = Get-Content -Raw -Path "C:\APPL\PowerShell\Playground\GetDbConnectionString.json" | ConvertFrom-Json
    
    $server_port = $config.server_port
    $database = $config.database
    $userid = $config.userid
    $vault = $config.password.vault
    $secret = $config.password.secret
    
    $securePassword = (Get-AzKeyVaultSecret -VaultName $vault -Name $secret).SecretValue
    $password = [System.Net.NetworkCredential]::new("", $securePassword).Password
    
    return "Server=$server_port;Database=$database;User Id='$userid';Password='$password';"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUjKKu9LfR1Ls72JuoolFhBNZQ
# 7cegggMYMIIDFDCCAfygAwIBAgIQegXJmptVUKlJaZjT11rO5zANBgkqhkiG9w0B
...
# FTAjBgkqhkiG9w0BCQQxFgQUOxlNE0nxUTusen2XJ2l5vhs79kQwDQYJKoZIhvcN
# AQEBBQAEggEAU3XaKbwDYAx5JbkelpOjKe55r0jrInHaRmMIDFpa4a2Z15+ZUS8K
# 976vO6Qs+rP6rsYQsTz0zBbIAkWt/l8GLhYgVMg2ciMXLGF9fVla5DTDywLp+ncd
# l6fIrsycWlgB3qa88fsvDdctrVV6h7+V8WW/WuXs0XGf5JkhZ7Aq8q316R6u4FQM
# Vak/5EiGKwetqCHCRd0uxWWuJQfnJ8jpmtsQeVHIen29UH6N19roUGgj5ZyWCP7j
# VvPLfH1wxhAUtlUWjd0AvhpQhM5/zeGw5UqfRMxoJYjmROrwYHgtt16HXAX928TR
# PgOGqqp185fzazCpfPjBzF+Cv8k+MCsIhw==
